        ...
        <div className="status-bar-info">
          ...
          <div className="status-bar-details">
            <div className="status-bar-title-row">
              ...
              <span className={`status-run-badge ${nodeStatus.online ? 'bg-[#FF6B35]/12 text-[#FF6B35] font-bold' : ''}`}>
          ...
          {postPreparePlots.map((plot) => (
            ...
            >
              <div className="flex justify-between items-start gap-2 border-b border-ui pb-2">
                ...
                {plot.flagged && (
                  <span className="bg-[#FF6B35]/15 text-[#FF6B35] text-[9px] font-bold px-2 py-0.5 rounded border border-[#FF6B35]/30">
                    Clipped
                  </span>
                )}
              </div>
