...
export const AgentManagerView: React.FC<AgentManagerViewProps> = ({ onSelectView }) => {
  const [agents, setAgents] = useState<AgentConfig[]>([
    {
      id: 'agent_qwen3_4b',
      name: 'ARCHITECT (Qwen 3-4B)',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=Qwen3Architect&backgroundColor=280B43',
      title: 'Master MLOps Architect & Industrial Strategist',
      role: 'Industrial Goal Mapping, Schema Profiling & MLOps DAG Composition',
      ...
      systemPrompt: 'You are Qwen 3-4B, Master Architect. Compose optimal MLOps DAG topologies (DAG-514 Turbofan RUL Engine) and map industrial user intent.',
    ...
    {
      id: 'agent_qwen2_5_3b',
      name: 'CODER (Qwen 2.5-3B)',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=Qwen3BCode&backgroundColor-[#E86326]',
      title: 'Code Specialist & Math Engineer',
      role: 'Feature Engineering Code Generation, Matrix Math & AutoML Fitting',
      ...
      systemPrompt: 'Generate rolling lag feature engineering code, fit XGBoost/LightGBM ensembles, and construct the Sankey Flow matrix.',
    ...
    {
      id: 'agent_qwen2_5_1_5b',
      name: 'EDGE GUARD (Qwen 1.5B)',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=Qwen15BGuard&backgroundColor=3C1053',
      title: 'Edge Telemetry & Anomaly Guard',
      role: 'High-Speed Signal Validation, Z-Score Outlier Bounds & ONNX Safety',
      endpoint: '/api/v1/physics/transform',
      status: 'Active',
      modelProvider: 'Qwen2.5-Coder-1.5B-Instruct (Local GGUF)',
      temperature: 0.0,
      maxTokens: 1024,
      latencySlaMs: 12,
      assignedPort: ':8000',
      calledByPages: ['Deployment Studio', 'Physics Gateway', 'ONNX Runtime'],
      systemPrompt: 'Validate live sensor telemetry vectors, filter Z-score anomalies, and compute FFT signal harmonics.',
      apiKeyMasked: 'local_gguf_models/qwen2.5-coder-1.5b-instruct-q4_k_m.gguf',
