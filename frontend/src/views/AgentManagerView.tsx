  ...
  const [agents, setAgents] = useState<AgentConfig[]>([
    {
      id: 'agent_jane',
      name: 'JANE',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=JaneCopilot&backgroundColor=280B43',
      title: 'Lead AI Copilot & MLOps Assistant',
      role: 'NLP Intent Classification, Context RAG & Pipeline Guidance',
      endpoint: '/api/v1/agents/jane-copilot',
      status: 'Active',
      modelProvider: 'Gemini 1.5 Pro (Industrial Mesh)',
      temperature: 0.2,
      maxTokens: 4096,
      latencySlaMs: 95,
      assignedPort: ':8002',
      calledByPages: ['Header Bar', 'Jane Floating Copilot', 'Data Explorer'],
      systemPrompt: 'You are Jane, the Lead AI Copilot for TAS AI-ConneX. You guide engineers through telemetry ingestion, RUL degradation curves, and 9-node cascade pipelines.',
      apiKeyMasked: 'aic_live_sk_••••••••••••9F2A',
      totalCallsToday: 18420,
      successRate: 99.9,
      tokenUsageTokens: 482100,
      ragDocsCount: 18,
      vectorDbStatus: 'Qdrant Vector Mesh (Connected)',
      concurrencyLimit: 16,
      replicas: 4,
    },
    {
      id: 'agent_victor',
      name: 'VICTOR',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=VictorArchitect&backgroundColor=FF6B35',
      title: 'SCADA Ingestion & Relational Graph Architect',
      role: 'Multi-Table Join-Graph & OPC-UA Primary Key Profiler',
      endpoint: '/api/v1/agents/victor-ingest',
      status: 'Active',
      modelProvider: 'DeepSeek R1 (Quantized)',
      temperature: 0.1,
      maxTokens: 2048,
      latencySlaMs: 65,
      assignedPort: ':8000',
      calledByPages: ['Compiler Suite (Page 1)', 'Master Data Hub'],
      systemPrompt: 'Inspect multi-sub-file CSV archives. Detect timestamp primary keys, unit entity IDs, and prevent row explosion Cartesian joins during compilation.',
      apiKeyMasked: 'aic_live_sk_••••••••••••4B71',
      totalCallsToday: 12940,
      successRate: 100.0,
      tokenUsageTokens: 310450,
      ragDocsCount: 12,
    ...
    },
    {
      id: 'agent_alexa',
      name: 'ALEXA',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=AlexaEngine&backgroundColor=3C1053',
      title: 'AutoML Architecture & RUL Prediction Engine',
      role: 'DAG Recipe Selection & Predictive Model Recommender',
      endpoint: '/api/v1/agents/alexa-automl',
      status: 'Active',
      modelProvider: 'Claude 3.5 Sonnet (Enterprise)',
      temperature: 0.25,
      maxTokens: 4096,
      latencySlaMs: 140,
      assignedPort: ':8001',
      calledByPages: ['DAG Inspector (1993 Catalog)', 'Train Node Page 7'],
      systemPrompt: 'Select optimal ML algorithms (XGBoost, LightGBM, Random Forest, LSTM) based on feature sparsity, target variance, and sampling rates.',
      apiKeyMasked: 'aic_live_sk_••••••••••••1E89',
      totalCallsToday: 9150,
      successRate: 99.6,
      tokenUsageTokens: 520100,
      ragDocsCount: 24,
      vectorDbStatus: 'Pinecone Enterprise Vector Index (Online)',
      concurrencyLimit: 12,
      replicas: 3,
    },
    {
      id: 'agent_marcus',
      name: 'MARCUS',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=MarcusSecurity&backgroundColor=1A0530',
      title: 'Zero-Leakage Security & Feature Synthesis Lead',
      role: 'Rolling Lag & Frequency Domain FFT Feature Synthesizer',
      endpoint: '/api/v1/agents/marcus-features',
      status: 'Active',
      modelProvider: 'AI-ConneX Core Feature Engine v2',
      temperature: 0.0,
      maxTokens: 1024,
      latencySlaMs: 40,
      assignedPort: ':8004',
      calledByPages: ['Feature Engineer Node Page 5', 'Validation Gate 1'],
      systemPrompt: 'Generate rolling lag derivatives, time-between-failure delta metrics, and spectral features while enforcing zero future-target leakage.',
      apiKeyMasked: 'aic_live_sk_••••••••••••8C44',
      totalCallsToday: 24100,
      successRate: 100.0,
      tokenUsageTokens: 198000,
      ragDocsCount: 8,
      vectorDbStatus: 'ChromaDB Local Engine (Connected)',
      concurrencyLimit: 32,
      replicas: 8,
    },
    {
      id: 'agent_elena',
      name: 'ELENA',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=ElenaHPO&backgroundColor=FF6B35',
      title: 'Bayesian HPO Optimization Specialist',
      role: 'Hyperparameter Trial Search & Early Stopping Controller',
      endpoint: '/api/v1/agents/elena-hpo',
      status: 'Active',
      modelProvider: 'Optuna + AI-ConneX Core Mesh',
      temperature: 0.35,
      maxTokens: 2048,
      latencySlaMs: 160,
      assignedPort: ':8006',
      calledByPages: ['Validation Gate 1 (Node 6)', 'Train Node Page 7'],
      systemPrompt: 'Execute multi-objective Bayesian hyperparameter optimization search over learning rate, tree depth, and L1/L2 regularization bounds.',
      apiKeyMasked: 'aic_live_sk_••••••••••••3D02',
      totalCallsToday: 6840,
      successRate: 99.4,
      tokenUsageTokens: 285400,
      ragDocsCount: 15,
      vectorDbStatus: 'Qdrant Vector Mesh (Connected)',
      concurrencyLimit: 16,
      replicas: 4,
    },
    {
      id: 'agent_david',
      name: 'DAVID',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=DavidONNX&backgroundColor=280B43',
      title: 'ONNX Edge Packaging & Deployment Specialist',
      role: 'INT8 Quantization & Microservice Container Exporter',
      endpoint: '/api/v1/agents/david-onnx',
      status: 'Active',
      modelProvider: 'ONNX Runtime v1.18 API',
      temperature: 0.0,
      maxTokens: 512,
      latencySlaMs: 85,
      assignedPort: ':8008',
      calledByPages: ['Validation Gate 2 (Node 8)', 'Deploy Node Page 9'],
      systemPrompt: 'Package validated model artifacts into optimized INT8 ONNX binaries ready for edge gateway deployment (MQTT/OPC-UA).',
      apiKeyMasked: 'aic_live_sk_••••••••••••7F11',
      totalCallsToday: 4920,
      successRate: 99.9,
      tokenUsageTokens: 142000,
      ragDocsCount: 10,
      vectorDbStatus: 'ChromaDB Local Engine (Connected)',
      concurrencyLimit: 20,
      replicas: 5,
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[10px] font-mono text-muted truncate max-w-[170px]">
                    🧠 {agent.modelProvider.split(' ')[0]} {agent.modelProvider.split(' ')[1]}
                  </span>
                  <button className="px-3.5 py-1.5 bg-[#2B0063] group-hover:bg-[#FF6B35] text-white font-mono text-xs font-bold rounded-xl transition-all shadow-sm flex items-center gap-1">
