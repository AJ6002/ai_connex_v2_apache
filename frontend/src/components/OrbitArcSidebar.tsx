...
export const OrbitArcSidebar: React.FC<OrbitArcSidebarProps> = ({ currentView, onSelectView }) => {
  ...
  const outerNavItems: NavItem[] = [
    { id: 'landing', label: 'Page 1: Landing Chatbox', shortLabel: 'Prompt', icon: 'chat', badge: 'Page 1', cluster: 'ingestion' },
    { id: 'compiler', label: 'Page 2: Upload Page', shortLabel: 'Upload', icon: 'upload_file', badge: 'Page 2', cluster: 'ingestion' },
    { id: 'data_explorer', label: 'Page 3: Data Explorer', shortLabel: 'Explore', icon: 'bar_chart', badge: 'Page 3', cluster: 'ingestion' },
    { id: 'node4', label: 'Page 4: Prepare Node', shortLabel: 'Prepare', icon: 'cleaning_services', badge: 'Page 4', cluster: 'ingestion' },
    { id: 'vg1', label: 'Page 5: Validation Gate 1', shortLabel: 'VG 1', icon: 'verified', badge: 'Page 5', cluster: 'ingestion' },
    { id: 'node5', label: 'Page 6: Feature Engineer Node', shortLabel: 'Features', icon: 'science', badge: 'Page 6', cluster: 'mlops' },
    { id: 'node7', label: 'Page 7: Train Node', shortLabel: 'Train', icon: 'model_training', badge: 'Page 7', cluster: 'mlops' },
    { id: 'vg2', label: 'Page 8: Validation Gate 2', shortLabel: 'VG 2', icon: 'fact_check', badge: 'Page 8', cluster: 'mlops' },
    { id: 'node9', label: 'Page 9: Deploy Node', shortLabel: 'Deploy', icon: 'rocket_launch', badge: 'Page 9', cluster: 'mlops' },
    { id: 'pipeline_studio', label: 'Page 10: Monitor Node', shortLabel: 'Monitor', icon: 'monitoring', badge: 'Page 10', cluster: 'mlops' },
