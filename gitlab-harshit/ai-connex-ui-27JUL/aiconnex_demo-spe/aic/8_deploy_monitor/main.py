...
def deploy_model(payload: DeployPayload):
    try:
        ...
        base_aic_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
        final_model_dir = os.path.join(base_aic_dir, "final_model")
        ...
        family_id = "F0"
        excel_path = os.path.join(base_aic_dir, "algorithm_families_complete.xlsx")
        if not os.path.exists(excel_path):
            excel_path = os.path.join(base_aic_dir, "algorithm_families.xlsx")
