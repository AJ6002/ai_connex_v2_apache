...
function PostTrainChartRenderer({ type, id, flagged }) {
...
export default function PostTrain() {
  const [activeCategory, setActiveCategory] = useState('split');
    ...
    <div className="page-container">
      ...
      <div className="status-action-bar">
        <div className="status-bar-info">
          <div className="status-bar-icon-block" style={{ color: '#ec4899', backgroundColor: 'rgba(236, 72, 153, 0.1)' }}>
            <Cpu size={20} />
          </div>
          <div className="status-bar-details">
            <div className="status-bar-title-row">
              ...
              <span className="status-run-badge">
                <CheckCircle size={12} style={{ color: '#10b981' }} /> Model Compiled
              </span>
            </div>
            ...
            <div className="status-bar-parameters">
              <div className="param-item">
                ...
                <span className="highlight-orange">One-class SVM (RBF Kernel)</span>
              </div>
              <span className="bullet-dot">•</span>
              <div className="param-item">
                <span>🎯 Validation F1: </span>
                <span className="highlight-green">0.941</span>
              </div>
              <span className="bullet-dot">•</span>
              <div className="param-item">
                <span>⏱️ Training time: </span>
                <span className="highlight-blue">4.8s (120 Epochs)</span>
              </div>
            </div>
          </div>
        </div>
        
        <button className="proceed-cta-btn" style={{ backgroundColor: '#ec4899', boxShadow: '0 4px 10px rgba(236, 72, 153, 0.2)' }}>
          Publish to Registry <ArrowRight size={16} />
        </button>
      </div>

      {/* Info Callout */}
      <div className="info-callout-banner" style={{ backgroundColor: '#fdf2f8', borderColor: '#fbcfe8', color: '#be185d' }}>
