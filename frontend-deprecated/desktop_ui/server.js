...
const server = http.createServer((req, res) => {
    ...
    // Route resolution for desktop_app and chat_app
    let normalizedPath = pathname;
    if (pathname === '/' || pathname.startsWith('/aiconnex_hero_desktop') || pathname === '/desktop') {
        normalizedPath = '/desktop_app/code.html';
    } else if (pathname.startsWith('/aiconnex_hero_chat_open') || pathname === '/chat') {
        normalizedPath = '/chat_app/code.html';
    }
