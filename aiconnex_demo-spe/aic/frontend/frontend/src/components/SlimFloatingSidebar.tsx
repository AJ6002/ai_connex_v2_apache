  ...
  const mainGroups: NavGroup[] = [
    {
      ...
      items: [
        { id: 'compiler', label: 'Page 1: Home / Upload', shortLabel: 'Upload', icon: 'upload_file', badge: 'Page 1' },
        { id: 'node4', label: 'Page 2: Prepare Node', shortLabel: 'Prepare', icon: 'cleaning_services', badge: 'Page 2' },
        { id: 'vg1', label: 'Page 3: Validation Gate 1', shortLabel: 'VG 1', icon: 'verified', badge: 'Page 3' },
        { id: 'node5', label: 'Page 4: Feature Engineer Node', shortLabel: 'Features', icon: 'science', badge: 'Page 4' },
        { id: 'node7', label: 'Page 5: Train Node', shortLabel: 'Train', icon: 'model_training', badge: 'Page 5' },
        { id: 'vg2', label: 'Page 6: Validation Gate 2', shortLabel: 'VG 2', icon: 'fact_check', badge: 'Page 6' },
        { id: 'node9', label: 'Page 7: Deploy Node', shortLabel: 'Deploy', icon: 'rocket_launch', badge: 'Page 7' },
        { id: 'pipeline_studio', label: 'Page 8: Monitor Node', shortLabel: 'Monitor', icon: 'monitoring', badge: 'Page 8' },
      ],
    },
    {
