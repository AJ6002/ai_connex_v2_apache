        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm overflow-x-auto min-w-[1200px] relative">
          ...
          <div className="grid grid-cols-12 gap-4 items-center py-8 relative">
            ...
            <div className="col-span-2 flex flex-col items-center justify-center space-y-4">
              <div className="p-4 bg-white border-2 border-tas-blue rounded-full shadow-md text-center hover:scale-105 transition-transform cursor-pointer w-36 h-36 flex flex-col items-center justify-center">
            ...
            <div className="col-span-2 flex flex-col items-center justify-center space-y-3">
              <div className="p-5 bg-white border-4 border-tas-blue text-tas-blue rounded-full shadow-lg text-center w-40 h-40 flex flex-col items-center justify-center relative">
            ...
            <div className="col-span-2 space-y-2 bg-slate-50/70 p-4 border border-slate-200 rounded-xl shadow-xs">
              ...
              <div className="p-2 bg-white border border-slate-200 rounded-md flex justify-between items-center text-xs font-mono">
              ...
              <div className="p-2 bg-tas-blue text-white rounded-md flex justify-between items-center text-xs font-mono shadow-2xs">
